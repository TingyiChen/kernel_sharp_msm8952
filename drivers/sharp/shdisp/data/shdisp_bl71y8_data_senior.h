/* drivers/sharp/shdisp/data/shdisp_bl71y8_data_senior.h  (Display Driver)
 *
...
/* ------------------------------------------------------------------------- */
#ifndef SHDISP_BL71Y8_DATA_SENIOR_H
#define SHDISP_BL71Y8_DATA_SENIOR_H
...
#define SHDISP_BKL_EMERGENCY_LIMIT_AUTO_LEVEL0  (595)
#define SHDISP_BKL_EMERGENCY_LIMIT_AUTO_LEVEL1  (99)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX_LEVEL0   (0x7D)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX_LEVEL1   (0x15)
#define SHDISP_BKL_PWM_LOWER_LIMIT              (0x000F)
#define SHDISP_BKL_PWM_LOWER_LIMIT_ZERO         (0x000F)
...
#define BDIC_REG_OPT_TH_SHIFT_17_16_VAL         (0x40)
...
#define BDIC_REG_OPT3_HT_L_VAL                  (0x85)
#define BDIC_REG_OPT3_HT_H_VAL                  (0x00)
#define BDIC_REG_OPT4_LT_L_VAL                  (0x6B)
#define BDIC_REG_OPT4_LT_H_VAL                  (0x00)
#define BDIC_REG_OPT4_HT_L_VAL                  (0xE0)
#define BDIC_REG_OPT4_HT_H_VAL                  (0x00)
#define BDIC_REG_OPT5_LT_L_VAL                  (0xC0)
#define BDIC_REG_OPT5_LT_H_VAL                  (0x00)
#define BDIC_REG_OPT5_HT_L_VAL                  (0x60)
#define BDIC_REG_OPT5_HT_H_VAL                  (0x01)
#define BDIC_REG_OPT6_LT_L_VAL                  (0x30)
#define BDIC_REG_OPT6_LT_H_VAL                  (0x01)
#define BDIC_REG_OPT6_HT_L_VAL                  (0x45)
#define BDIC_REG_OPT6_HT_H_VAL                  (0x02)
#define BDIC_REG_OPT7_LT_L_VAL                  (0xEB)
#define BDIC_REG_OPT7_LT_H_VAL                  (0x01)
#define BDIC_REG_OPT7_HT_L_VAL                  (0x6B)
#define BDIC_REG_OPT7_HT_H_VAL                  (0x03)
#define BDIC_REG_OPT8_LT_L_VAL                  (0x05)
#define BDIC_REG_OPT8_LT_H_VAL                  (0x03)
#define BDIC_REG_OPT8_HT_L_VAL                  (0x85)
#define BDIC_REG_OPT8_HT_H_VAL                  (0x05)
#define BDIC_REG_OPT9_LT_L_VAL                  (0xAB)
#define BDIC_REG_OPT9_LT_H_VAL                  (0x04)
#define BDIC_REG_OPT9_HT_L_VAL                  (0x60)
#define BDIC_REG_OPT9_HT_H_VAL                  (0x0A)
#define BDIC_REG_OPT10_LT_L_VAL                 (0x60)
#define BDIC_REG_OPT10_LT_H_VAL                 (0x08)
#define BDIC_REG_OPT10_HT_L_VAL                 (0xD5)
#define BDIC_REG_OPT10_HT_H_VAL                 (0x10)
#define BDIC_REG_OPT11_LT_L_VAL                 (0x9B)
#define BDIC_REG_OPT11_LT_H_VAL                 (0x0E)
#define BDIC_REG_OPT11_HT_L_VAL                 (0x85)
#define BDIC_REG_OPT11_HT_H_VAL                 (0x1A)
#define BDIC_REG_OPT12_LT_L_VAL                 (0xCB)
#define BDIC_REG_OPT12_LT_H_VAL                 (0x16)
#define BDIC_REG_OPT12_HT_L_VAL                 (0x15)
#define BDIC_REG_OPT12_HT_H_VAL                 (0x2C)
#define BDIC_REG_OPT13_LT_L_VAL                 (0x2B)
#define BDIC_REG_OPT13_LT_H_VAL                 (0x25)
#define BDIC_REG_OPT13_HT_L_VAL                 (0x4B)
#define BDIC_REG_OPT13_HT_H_VAL                 (0x40)
#define BDIC_REG_OPT14_LT_L_VAL                 (0xA5)
#define BDIC_REG_OPT14_LT_H_VAL                 (0x39)
#define BDIC_REG_OPT14_HT_L_VAL                 (0x85)
#define BDIC_REG_OPT14_HT_H_VAL                 (0x62)
#define BDIC_REG_OPT15_LT_L_VAL                 (0xBB)
#define BDIC_REG_OPT15_LT_H_VAL                 (0x54)
#define BDIC_REG_OPT15_HT_L_VAL                 (0xC5)
#define BDIC_REG_OPT15_HT_H_VAL                 (0x9E)
#define BDIC_REG_OPT16_LT_L_VAL                 (0x8B)
#define BDIC_REG_OPT16_LT_H_VAL                 (0x87)
#define BDIC_REG_OPT16_HT_L_VAL                 (0x0B)
#define BDIC_REG_OPT16_HT_H_VAL                 (0xE0)
#define BDIC_REG_OPT17_LT_L_VAL                 (0xB0)
#define BDIC_REG_OPT17_LT_H_VAL                 (0x0C)
#define BDIC_REG_OPT17_HT_L_VAL                 (0x6C)
#define BDIC_REG_OPT17_HT_H_VAL                 (0x14)
#define BDIC_REG_OPT18_LT_L_VAL                 (0xDE)
#define BDIC_REG_OPT18_LT_H_VAL                 (0x11)
#define BDIC_REG_OPT18_HT_L_VAL                 (0xF2)
#define BDIC_REG_OPT18_HT_H_VAL                 (0x1F)
#define BDIC_REG_OPT19_LT_L_VAL                 (0x76)
#define BDIC_REG_OPT19_LT_H_VAL                 (0x1B)
#define BDIC_REG_OPT19_HT_L_VAL                 (0xD3)
#define BDIC_REG_OPT19_HT_H_VAL                 (0x2D)
#define BDIC_REG_OPT20_LT_L_VAL                 (0x20)
#define BDIC_REG_OPT20_LT_H_VAL                 (0x29)
#define BDIC_REG_OPT20_HT_L_VAL                 (0x3E)
#define BDIC_REG_OPT20_HT_H_VAL                 (0x46)
#define BDIC_REG_OPT21_LT_L_VAL                 (0x62)
#define BDIC_REG_OPT21_LT_H_VAL                 (0x3C)
#define BDIC_REG_OPT21_HT_L_VAL                 (0x22)
#define BDIC_REG_OPT21_HT_H_VAL                 (0x7A)
#define BDIC_REG_OPT22_LT_L_VAL                 (0x1E)
#define BDIC_REG_OPT22_LT_H_VAL                 (0x65)
#define BDIC_REG_OPT22_HT_L_VAL                 (0x83)
#define BDIC_REG_OPT22_HT_H_VAL                 (0xB1)
#define BDIC_REG_OPT23_LT_L_VAL                 (0x55)
#define BDIC_REG_OPT23_LT_H_VAL                 (0xA0)
...
#endif /* SHDISP_BL71Y8_DATA_SENIOR_H */
