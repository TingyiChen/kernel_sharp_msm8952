...
#define SHDISP_BKL_EMERGENCY_LIMIT_AUTO_LEVEL0  (480)
#define SHDISP_BKL_EMERGENCY_LIMIT_AUTO_LEVEL1  (99)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX_LEVEL0   (0x65)
#define SHDISP_BKL_EMERGENCY_LIMIT_FIX_LEVEL1   (0x15)
#define SHDISP_BKL_PWM_LOWER_LIMIT              (0x00E)
#define SHDISP_BKL_PWM_LOWER_LIMIT_ZERO         (0x00E)
