/* include/sharp/shtps_dev_focaltech.h
 *
...
#if defined( CONFIG_SHTPS_FOCALTECH_FT8607_5 ) || defined( CONFIG_SHTPS_FOCALTECH_FT8607_6 )
	#define SHTPS_TM_TXNUM_MAX		27
	#define SHTPS_TM_RXNUM_MAX		16
#elif defined( CONFIG_SHTPS_FOCALTECH_FT8607_7 )
	#define SHTPS_TM_TXNUM_MAX		27
	#define SHTPS_TM_RXNUM_MAX		16
#else
	#define SHTPS_TM_TXNUM_MAX		27
